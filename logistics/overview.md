...
- **Tutorial:** 45% You will pick a technique related to the course material, and create a tutorial on that topic so that it's accessible to an undergraduate senior. The deliverables are:
...
- **Paper review:** 10% You will find a published research paper on a topic of your choice, and you will write a review on the paper.
